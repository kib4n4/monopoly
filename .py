...
from board import *
from comp import computerTurn  
# Importing the computer turn logic from comp module
...
class Player:
    ...
    def tokenSelection(self):
        # Method for selecting a token at the start of the game
    ...
    def move(self, roll):
        # Moves the player's position based on the dice roll
    ...
    def mortgageProperty(self):
        # Allows the player to mortgage a property they own
    ...
    while True:
        if current_player.is_computer:
            computerTurn(current_player) 
             # Call the computer's turn logic from comp module
        else:
