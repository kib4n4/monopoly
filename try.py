...
def mortgaging(player):
    if not player.properties: 
        #check if player ownn any properties 
        print(f"{player.token}, you do not own any properties.")
        return
...
def play_game():
    ...
    #makes the current player playing game to be player 1 at start of the game.
